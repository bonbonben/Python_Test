...
# If we try to model a bank account we have to make sure the account is locked down during a transaction
# so that if more then 1 person tries to withdrawal money at once we don't give out more money then is in the account
